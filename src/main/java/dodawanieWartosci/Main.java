...
public class Main {
    ...
    The method should take an array of longs and
    add value to the specified element by its index.
    ...
    Where array is an array of longs, index is an
    integer variable, value is a long value for adding.
*/
